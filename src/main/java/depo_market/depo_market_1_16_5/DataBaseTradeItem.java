...
public class DataBaseTradeItem {
    ...
    public DataBaseTradeItem(){
        ...
        this.MenuSlotList.add(new ItemMenuSlot(Material.WOLF_SPAWN_EGG, "WOLF_SPAWN_EGG", "オオカミ", 4000f));
        this.MenuSlotList.add(new ItemMenuSlot(Material.BONE, "BONE", "骨", 500f));

        ItemEnchantData eItem;
        eItem = new ItemEnchantData(Material.DIAMOND_PICKAXE, "LuckyPICKAXE", "幸運ピッケル", 20000f);
        eItem.addEnchant(Enchantment.LOOT_BONUS_BLOCKS, 3);
        this.itemEnchantList.add(eItem);
        eItem = new ItemEnchantData(Material.DIAMOND_PICKAXE, "PoweredPICKAXE", "強化ピッケル", 20000f);
        ...
        this.itemEnchantList.add(eItem);
        eItem = new ItemEnchantData(Material.DIAMOND_HELMET, "PoweredDIAMOND_HELMET", "ダメージ低下ダイヤヘルメット", 30000f);
        eItem.addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4);
        this.itemEnchantList.add(eItem);
        eItem = new ItemEnchantData(Material.DIAMOND_CHESTPLATE, "PoweredDIAMOND_CHESTPLATE", "ダメージ低下ダイヤ鎧上", 30000f);
        eItem.addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4);
        this.itemEnchantList.add(eItem);
        eItem = new ItemEnchantData(Material.DIAMOND_LEGGINGS, "PoweredDIAMOND_LEGGINGS", "ダメージ低下ダイヤ鎧下", 20000f);
        eItem.addEnchant(Enchantment.PROTECTION_ENVIRONMENTAL, 4);
        this.itemEnchantList.add(eItem);
        eItem = new ItemEnchantData(Material.DIAMOND_BOOTS, "PoweredDIAMOND_BOOTS", "落下ダメージ低下ダイヤ靴", 20000f);
